    ...
    <section className="py-24 lg:py-32 bg-graphite relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div ref={section.ref} className={`max-w-3xl mx-auto text-center reveal-scale ${section.isVisible ? "visible" : ""}`}>
          <p className="font-body text-sm tracking-[0.3em] uppercase text-gold mb-6">Próximo Paso</p>
          <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl text-sand leading-tight mb-6">
            Descubra el máximo potencial de su estética con un plan{" "}
            <span className="text-gold italic">personalizado</span> y de alto nivel.
          </h2>
          <p className="font-body text-lg text-sand/60 leading-relaxed mb-10 max-w-2xl mx-auto">
            Agende su valoración y conozca el tratamiento ideal para valorar su individualidad con seguridad, precisión y naturalidad.
          </p>
          <a
            href={WHATSAPP_URL}
            target="_blank"
